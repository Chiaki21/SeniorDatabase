...
<body>
  ...
  <?php if ($currentpage > 1) : ?>
    <a href="?page=1<?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&barangay=<?php echo $selectedBarangay; ?>">First</a>
    <a href="?page=<?php echo ($currentpage - 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&barangay=<?php echo $selectedBarangay; ?>">Previous</a>
  <?php endif; ?>
  ...
  <?php for ($i = $startPage; $i <= $endPage; $i++) : ?>
    ...
    <?php else : ?>
      <a href="?page=<?php echo $i; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&barangay=<?php echo $selectedBarangay; ?>"><?php echo $i; ?></a>
    <?php endif; ?>
  <?php endfor; ?>

  <?php if ($currentpage < $totalPages) : ?>
    <a href="?page=<?php echo ($currentpage + 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&barangay=<?php echo $selectedBarangay; ?>">Next</a>
    <a href="?page=<?php echo $totalPages; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&barangay=<?php echo $selectedBarangay; ?>">Last</a>
  <?php endif; ?>
</div>
      </div>
