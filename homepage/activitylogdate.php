...
<?php if (isset($error_msg)): ?>
  ...
  <section class="home-section">
    ...
    <div class="home-content">
         <!-- DISPLAY THE NO EVENT HAPPENED IN THIS DATE -->
         <section class="activity-log">
  <form onsubmit="event.preventDefault(); filterLog();" class="date-selection-form">
  ...
  <?php
    ...
    // Display the message if no rows are found
    echo "<p style='text-align: center;'>No history event</p>";
  }
  ?>
</section>
  ...
  function filterLog() {
    ...
    // You can perform any additional filtering logic here if needed
    window.location.href = `activitylogdate.php?selected_date=${selectedDate}`;
  }

  // On page load, update the date input value with the selected date if present in the URL query
  let urlSearchParams = new URLSearchParams(window.location.search);
  let selectedDateParam = urlSearchParams.get('selected_date');
  if (selectedDateParam) {
    selectedDateInput.value = selectedDateParam;
    // Check if the input has a value and set the visibility of the clear button accordingly
