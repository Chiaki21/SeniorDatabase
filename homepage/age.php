...
$sqlCount = "SELECT COUNT(*) as total FROM people WHERE birthDate BETWEEN '$startDate' AND '$endDate'";
$sqlSelect = "SELECT * FROM people WHERE birthDate BETWEEN '$startDate' AND '$endDate' ORDER BY updated_date DESC LIMIT $offset, $recordsPerPage";
...
<body>
  ...
  <?php if ($currentpage > 1) : ?>
    <a href="?page=1<?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&age=<?php echo $selectedAge; ?>">First</a>
    <a href="?page=<?php echo ($currentpage - 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&age=<?php echo $selectedAge; ?>">Previous</a>
  <?php endif; ?>
  ...
  <?php for ($i = $startPage; $i <= $endPage; $i++) : ?>
    ...
    <?php else : ?>
      <a href="?page=<?php echo $i; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&age=<?php echo $selectedAge; ?>"><?php echo $i; ?></a>
    <?php endif; ?>
  <?php endfor; ?>

  <?php if ($currentpage < $totalPages) : ?>
    <a href="?page=<?php echo ($currentpage + 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&age=<?php echo $selectedAge; ?>">Next</a>
    <a href="?page=<?php echo $totalPages; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&age=<?php echo $selectedAge; ?>">Last</a>
  <?php endif; ?>
</div>
