...
$totalResult = mysqli_query($conx, $sqlCount);
...
$todayResult = mysqli_query($conx, $todaySql);
...
$totalResult = mysqli_query($conx, $totalSql);
$totalRow = mysqli_fetch_assoc($totalResult);
...
for ($month = 1; $month <= 12; $month++) {
  ...
  $monthResult = mysqli_query($conx, $monthSql);
...
$latestPersonsResult = mysqli_query($conx, $latestPersonsSql);
$latestPersons = array();
...
$activeSeniorResult = mysqli_query($conx, $activeSenior);
        ...
        <div class="home-content">
            ...
            <div class="overview-boxes">
                ...
                <div class="box" onclick="location.href='todayreg.php';">
                    <div class="right-side">
                        <div class="box-topic" style="margin-right:100px">Today's Registrants</div>
                        <!-- CHANGE TO Month's Registrants-->
            ...
            <div class="sales-boxes">
                                ...
                                onClick: (event, elements) => {
                                    if (elements && elements.length > 0) {
                                        ...
                                        const selectedYear = document.querySelector(
                                            'select[name="selectYear"]').value;
                                        window.location.href =
                                            `month.php?year=${selectedYear}&month=${selectedMonth}`;
                                    }
                                }
                            }
                        });
                ...
                <div class="top-sales box">
                    <div class="title">Recent Person Added <button class="btn btn-more"
                            onclick="window.location.href='homelog.php'">See More</button></div>
                    <ul class="top-sales-details">

                        <?php foreach ($latestPersons as $person) : ?>

                        <li class="personfield"
                            onclick="window.location.href='view.php?id=<?php echo $person['id']; ?>';">
                            <a>
            ...
            <div class="sales-boxes">
                ...
                <div class="recent-sales box">
                    ...
                    new Chart(ageChart, {
                        type: 'line',
                        data: {
                            labels: ['60', '61', '62', '63', '64', '65', '66', '67', '68', '69', '70', '71',
                        ...
                        options: {
                            ...
                            onClick: function(event, elements) {
                                if (elements.length > 0) {
                                    ...
                                    window.location.href =
                                        `disabilities.php?disability=${encodeURIComponent(disability)}`;
                                }
                            },
                        },
                    });
                ...
                <div class="horBarChart box">
                    ...
                    <div class="chartCard">
                        <div class="horizontalBar">
                            <h1>Barangay</h1>
                            <canvas id="horBar" height="250"></canvas>
                        </div>
                    </div>
