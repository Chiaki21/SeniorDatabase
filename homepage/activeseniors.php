...
$recordsPerPage = 10; // Change this to the number of records per page you want to display
$currentpage = isset($_GET['page']) ? $_GET['page'] : 1;
$offset = ($currentpage - 1) * $recordsPerPage;
$searchQuery = '';
$sqlCount = "SELECT COUNT(*) as total FROM people WHERE personStatus = 'Active'";
$sqlSelect = "SELECT * FROM people WHERE personStatus = 'Active' ORDER BY updated_date DESC LIMIT $offset, $recordsPerPage";
...
<head>
  <meta charset="UTF-8" />
  <title>Senior Solutions | Show Active</title>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Active Seniors</span>
        <a href="deceasedseniors.php" class="btn btn-disable">Show Deceased</a>
      </div>
