...
<head>
  <meta charset="UTF-8" />
  <title>Senior Solutions | Today's Registrants</title>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Today's Registrants</span>
      </div>
...
<div class="profile-details">
    ...
    <tr>
        ...
        <td class="person-status <?php echo strtolower($data['personStatus']); ?>">
