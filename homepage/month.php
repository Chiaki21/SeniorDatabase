...
$sqlCount = "SELECT COUNT(*) as total FROM people WHERE YEAR(updated_date) = $selectedYear AND MONTH(updated_date) = $selectedMonth";
$sqlSelect = "SELECT * FROM people WHERE YEAR(updated_date) = $selectedYear AND MONTH(updated_date) = $selectedMonth ORDER BY updated_date DESC LIMIT $offset, $recordsPerPage";
...
<head>
    <meta charset="UTF-8" />
    <title>Senior Solutions | <?php echo date('F', mktime(0, 0, 0, $selectedMonth, 1)); ?></title>
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard"><?php echo date('F', mktime(0, 0, 0, $selectedMonth, 1)); ?> Registrants</span>
        ...
        <div class="home-content">
            ...
            <div class="pagination">
                ...
                <a
                    href="?page=1<?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&month=<?php echo $selectedMonth; ?>&year=<?php echo $selectedYear; ?>">First</a>
                <a
                    href="?page=<?php echo ($currentpage - 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&month=<?php echo $selectedMonth; ?>&year=<?php echo $selectedYear; ?>">Previous</a>
                <?php endif; ?>
                ...
                <?php else : ?>
                <a
                    href="?page=<?php echo $i; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&month=<?php echo $selectedMonth; ?>&year=<?php echo $selectedYear; ?>"><?php echo $i; ?></a>
                <?php endif; ?>
                <?php endfor; ?>

                <?php if ($currentpage < $totalPages) : ?>
                <a
                    href="?page=<?php echo ($currentpage + 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&month=<?php echo $selectedMonth; ?>&year=<?php echo $selectedYear; ?>">Next</a>
                <a
                    href="?page=<?php echo $totalPages; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&month=<?php echo $selectedMonth; ?>&year=<?php echo $selectedYear; ?>">Last</a>
                <?php endif; ?>
            </div>
