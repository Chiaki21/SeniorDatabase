...
<body>
        ...
        <div class="table-container">
          <table class="table">
            ...
            <a class="btn btn-all" id="allFilter" href="barangay.php?barangay=<?php echo urlencode($selectedBarangay); ?>">All</a>
              ...
              <h3 class="countGender">Female Count: <?php echo $userCount; ?></h3>
            </div>
            <thead>
              <tr>
                <th>RBI ID</th>
  ...
  <?php if ($currentpage > 1) : ?>
    <a href="?page=1&gender=Female&barangay=<?php echo urlencode($selectedBarangay); ?>">First</a>
    <a href="?page=<?php echo ($currentpage - 1); ?>&gender=Female&barangay=<?php echo urlencode($selectedBarangay); ?>">Previous</a>
  <?php endif; ?>
  ...
  <?php for ($i = $startPage; $i <= $endPage; $i++) : ?>
    ...
    <?php else : ?>
      <a href="?page=<?php echo $i; ?>&gender=Female&barangay=<?php echo urlencode($selectedBarangay); ?>"><?php echo $i; ?></a>
    <?php endif; ?>
  <?php endfor; ?>

  <?php if ($currentpage < $totalPages) : ?>
    <a href="?page=<?php echo ($currentpage + 1); ?>&gender=Female&barangay=<?php echo urlencode($selectedBarangay); ?>">Next</a>
    <a href="?page=<?php echo $totalPages; ?>&gender=Female&barangay=<?php echo urlencode($selectedBarangay); ?>">Last</a>
  <?php endif; ?>
</div>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // Redirect to the barangay.php when clicking on "All" button
