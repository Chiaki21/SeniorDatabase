  ...
  <section class="home-section">
    ...
    <header style="font-size: 35px">Senior Citizen Data Form</header>
      ...
      <br>
        ...
        <div class="input-box" style="margin-top: 100px;">
          <b>Reference Code</b>
          <input type="number" class="gray-input" placeholder="Reference Code"  name="referenceCode" id="referenceCode"/>
        </div>  
...
<div class="column">
  ...
  <label><span class="red-asterisk">*</span> Last Name</label>
    <input type="text" class="gray-input" placeholder="Enter last name"  name="lastName"  maxlength="20"  oninput="this.value = this.value.toUpperCase();" />
  </div>
  <div class="input-box">
    <label><span class="red-asterisk">*</span> First Name</label>
    <input type="text" class="gray-input" placeholder="Enter first name"   maxlength="20" name="firstName"  oninput="this.value = this.value.toUpperCase();" />
  </div>
  <div class="input-box">
    <label>Middle Name</label>
    <input type="text" class="gray-input" placeholder="Enter middle name" maxlength="20" name="middleName"   oninput="this.value = this.value.toUpperCase();"/>
  </div>
  <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter region" name="region" id="regionInput" readonly/>
        </div>
        <div class="input-box">
          <label><span class="red-asterisk">*</span> Province</label>
          <input type="text" class="gray-input" placeholder="Enter province" name="province" id="provinceInput" readonly/>
        </div>
        <div class="input-box">
          <label><span class="red-asterisk">*</span> City / Municipality</label>
          <input type="text" class="gray-input" placeholder="Enter city/municipality" name="city"  id="cityInput" readonly/>
        </div>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter house no."  name="houseno"   oninput="this.value = this.value.toUpperCase();"/>
        </div>
        <div class="input-box">
          <label>Street</label>
          <input type="text" class="gray-input" placeholder="Enter Street" name="street"  oninput="this.value = this.value.toUpperCase();"/>
        </div>
        </div>
  ...
  <input type="date" class="gray-input" placeholder="Enter birth date" name="birthDate" onchange="calculateAge()" />
  <span id="currentAge"></span>
</div>
        <div class="input-box">
          <b>4. Place of Birth</b>
          <input type="text" class="gray-input" placeholder="Enter place of birth" name="birthPlace" maxlength="20"/>
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="number" class="gray-input" placeholder="+63"  name="contactNumber" maxlength="10"/>
        </div>
        <div class="input-box">
          <b>8. Email Address</b>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter language spoken"  name="language"/>
        </div>
        </div>
        ...
        <div class="input-box">
          <b>12. OSCA ID</b>
          <input type="text" class="gray-input" placeholder="Enter Osca ID"  name="oscaID" oninput="restrictToNumbers(this)" />
        </div>
        <div class="input-box">
          <b>13. GSIS / SSS</b>
          <input type="text" class="gray-input" placeholder="0000000000" maxlength="10" name="sss" oninput="restrictToNumbers(this)"/>
        </div>
        <div class="input-box">
          <b>14. TIN ID</b>
          <div class="tin-input">
  <input type="text" class="gray-input" placeholder="000-000-000-000" name="tin" oninput="maskTIN(this)" />
</div>
        ...
        <div class="input-box">
  <b>15. Philhealth</b>
  <input type="text" class="gray-input" placeholder="00-000000000-0" name="philhealth" oninput="restrictToNumbersWithHyphen(this)"/>
</div>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter Employment" name="serviceEmp" maxlength="50"/>
        </div>
        <div class="input-box">
          <b>20. Current Pension / Specify</b>
          <input type="text" class="gray-input" placeholder="Enter current pension" name="pension" />
        </div>
        </div>
        </div>
    ...
    <span></span>
        ...
        <h1 style="background-color: lightblue; color: blackl; font-size: 25px">II. Family Composition</h1>
        <br>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="spouseLastName"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>First Name</label>
          <input type="text" class="gray-input" placeholder="Enter first name" name="spouseFirstName"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Middle Name</label>
          <input type="text" class="gray-input" placeholder="Enter middle name" name="spouseMiddleName" maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Extension (Jr, Sr)</label>
          <div class="select-box">
        ...
        <div class="input-box">
          <label>Last Name</label>
          <input type="text" class="gray-input" placeholder="Enter last name" name="fatherLastName"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>First Name</label>
          <input type="text" class="gray-input" placeholder="Enter first name"  name="fatherFirstName" maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Middle Name</label>
          <input type="text" class="gray-input" placeholder="Enter middle name" name="fatherMiddleName"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Extension (Jr, Sr)</label>
          <div class="select-box">
        ...
        <div class="input-box">
          <label>Last Name</label>
          <input type="text" class="gray-input" placeholder="Enter last name"  name="motherLastName"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>First Name</label>
          <input type="text" class="gray-input" placeholder="Enter first name" name="motherFirstName" maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Middle Name</label>
          <input type="text" class="gray-input" placeholder="Enter middle name" name="motherMiddleName" maxlength="20"/>
        </div>
        </div>
        <br>

        <b>24. Child(ren)</b> <p style="font-size: 14px">(leave blank if none)</p>
        <div class="column">
        <div class="input-box">
          <label><b>1. </b>Full Name</label>
          <input type="text" class="gray-input" placeholder="Enter last name" name="child1FullName"  maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation"  name="child1Occupation" maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income"  name="child1Income"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Age</label>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child2FullName"  maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation" name="child2Occupation" maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income" name="child2Income" />
        </div>
        <div class="input-box">
          <label>Age</label>
          <input type="number" class="gray-input" placeholder="Enter age" name="child2Age" maxlength="3"/>
        </div>
        <div class="input-box">
          <label>Working</label>
          <div class="select-box">
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child3FullName"  maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation" name="child3Occupation" maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income" name="child3Income" />
        </div>
        <div class="input-box">
          <label>Age</label>
          <input type="number" class="gray-input" placeholder="Enter age" name="child3Age" maxlength="3"/>
        </div>
        <div class="input-box">
          <label>Working</label>
          <div class="select-box">
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child4FullName" maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation" name="child4Occupation"  maxlength="20"/>
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income" name="child4Income" />
        </div>
        <div class="input-box">
          <label>Age</label>
          <input type="number" class="gray-input" placeholder="Enter age" name="child4Age" maxlength="3"/>
        </div>
        <div class="input-box">
          <label>Working</label>
          <div class="select-box">
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child5FullName"  maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child6FullName"  maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child7FullName" maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child8FullName"  maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child9FullName" maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Enter last name" name="child10FullName" maxlength="35"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
        ...
        <br>
        <b>25. Other Dependent</b> <p style="font-size: 14px">(leave blank if none)</p>
...
<div class="column">
        ...
        <div class="input-box">
          <label><b>1. </b>Full Name</label>
          <input type="text" class="gray-input" placeholder="Enter last name" name="dependentFullName"   />
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation" name="dependentOccupation"/>
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income" name="dependentIncome" />
        </div>
        <div class="input-box">
          <label>Age</label>
          <input type="number" class="gray-input" placeholder="Enter age" name="dependentAge" maxlength="3"/>
        </div>
        <div class="input-box">
          <label>Working</label>
          <div class="select-box">
      ...
      <div class="column">
        <div class="input-box">
          <label><b>2. </b>Full Name</label>
          <input type="text" class="gray-input" placeholder="Enter last name" name="dependent2FullName"  />
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation" name="dependent2Occupation"/>
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income" name="dependent2Income" />
        </div>
        <div class="input-box">
          <label>Age</label>
          <input type="number" class="gray-input" placeholder="Enter age" name="dependent2Age" maxlength="3"/>
        </div>
        <div class="input-box">
          <label>Working</label>
          <div class="select-box">
        ...
        <div class="input-box">
          <label><b>3. </b>Full Name</label>
          <input type="text" class="gray-input" placeholder="Enter last name" name="dependent3FullName"/>
        </div>
        <div class="input-box">
          <label>Occupation</label>
          <input type="text" class="gray-input" placeholder="Enter occupation" name="dependent3Occupation" />
        </div>
        <div class="input-box">
          <label>Income</label>
          <input type="number" class="gray-input" placeholder="Enter income" name="dependent3Income" />
        </div>
        <div class="input-box">
          <label>Age</label>
          <input type="number" class="gray-input" placeholder="Enter age" name="dependent3Age" maxlength="3"/>
        </div>
        <div class="input-box">
          <label>Working</label>
          <div class="select-box">
...
<div class="gender">
    ...
    <div class="gender">
      <input type="checkbox" id="check-27teaching" name="specialization[]" value="Teaching" />
      <label for="check-27teaching">Teaching</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-27legal" name="specialization[]" value="Legal Services"/>
    ...
    <div class="gender">
      <input type="checkbox" id="check-27counseling" name="specialization[]" value="Counseling" />
    ...
    <div class="gender">
      <input type="checkbox" id="check-27engineering" name="specialization[]" value="Engineering" />
      <label for="check-27engineering">Engineering</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-27carpenter" name="specialization[]" value="Carpenter"/>
    ...
    <div class="gender">
      <input type="checkbox" id="check-27sapatero" name="specialization[]" value="Sapatero"/>
      <label for="check-27sapatero">Sapatero</label>
    </div>

    <div class="gender">
      <input type="checkbox" id="check-27evangelization" name="specialization[]" value="Evangelization" />
    ...
    <div class="gender">
      <input type="checkbox" id="check-27milwright" name="specialization[]" value="Milwright"/>
  ...
  <div class="input-box">
   <label>Other area of specialization, specify if have</label>
    <input type="text" class="gray-input" placeholder="Enter other specialization"  name="specializationOthers"/>
</div>
...
<div class="columncheckbox">
    <div class="gender">
      <input type="checkbox" id="check-29medical" name="communityService[]" value="Medical"/>
      <label for="check-29medical">Medical</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29resource" name="communityService[]" value="Resource Volunteer" />
      <label for="check-29resource">Resource Volunteer</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29beautification" name="communityService[]" value="Community Beautification" />
      <label for="check-29beautification">Community Beautification</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29org" name="communityService[]" value="Community / Organization Leader"/>
      <label for="check-29org">Community / Organization Leader</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29dental" name="communityService[]" value="Dental" />
      <label for="check-29dental">Dental</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29friendlyvisits" name="communityService[]" value="Friendly Visits" />
    ...
    <div class="columncheckbox">
    <div class="gender">
      <input type="checkbox" id="check-29neighborhood" name="communityService[]" value="Neighborhood Support Services" />
      <label for="check-29neighborhood">Neighborhood Support Services</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29legalservices" name="communityService[]" value="Legal Services" />
      <label for="check-29legalservices">Legal Services</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29religous" name="communityService[]" value="Religious"/>
      <label for="check-29religous">Religious</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29counseling" name="communityService[]" value="Counseling / Referral" />
      <label for="check-29counseling">Counseling / Referral</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-29sponsorship" name="communityService[]" value="Sponsorship"/>
  ...
  <input type="text" class="gray-input" placeholder="Enter other involvement" name="communityServiceOthers"  maxlength="20"/>
</div>
</div>
<div class="column">
...
<div class="columncheckbox">
    ...
    <div class="gender">
      <input type="checkbox" id="check-30grandchild" name="residingwith[]" value="Grand Child(ren)"/>
      <label for="check-30grandchild">Grand Child(ren)</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-30commonlaw" name="residingwith[]" value="Common Law Spouse" />
    ...
    <div class="gender">
      <input type="checkbox" id="check-30careinstitution" name="residingwith[]" value="Care Institution" />
    ...
    <div class="columncheckbox">
    <div class="gender">
      <input type="checkbox" id="check-30children" name="residingwith[]" value="Child(ren)" />
      <label for="check-30children">Child(ren)</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-30relative" name="residingwith[]" value="Relative(s)" />
  ...
  <input type="text" class="gray-input" placeholder="Enter another involvment with" name="residingWithOthers"  maxlength="20"/>
</div>
  </div>
...
<b>31. Household Condition</b>
    ...
    <div class="gender">
      <input type="checkbox" id="check-31overcrowded" name="houseHold[]" value="Overcrowded in home"/>
    ...
    <div class="gender">
      <input type="checkbox" id="check-31nopermanent" name="houseHold[]" value="No permanent house" />
      <label for="check-31nopermanent">No permanent house</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-31highcostofrent" name="houseHold[]" value="High cost of rent" />
      <label for="check-31highcostofrent">High cost of rent</label>
    </div>
    <div class="gender">
      <input type="checkbox" id="check-31longing" name="houseHold[]" value="Longing for independent living quiet atmosphere"/>
  ...
  <input type="text" placeholder="Others" name="houseHoldOthers" maxlength="20"/>
    ...
    <h1 style="background-color: lightblue; color: black; font-size: 25px">V. Economic Profile</h1>
        ...
        <div class="columncheckbox">
            <div class="gender">
              <input type="checkbox" id="check-32ownearnings" name="sourceIncome[]" value="Own earnings of salary or Wages"/>
              <label for="check-32ownearnings">Own earnings of salary or Wages</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-32ownpension" name="sourceIncome[]" value="Own Pension"/>
              <label for="check-32ownpension">Own Pension</label>
            </div>
            
            <div class="gender">
              <input type="checkbox" id="check-32stocks" name="sourceIncome[]" value="Stocks / Dividends" />
              <label for="check-32stocks">Stocks / Dividends</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-32dependent" name="sourceIncome[]" value="Dependent on children / relatives"/>
              <label for="check-32dependent">Dependent on children / relatives</label>
            </div>
       
            <div class="gender">
              <input type="checkbox" id="check-32spousesalary" name="sourceIncome[]" value="Spouse salary" />
              <label for="check-32spousesalary">Spouse salary</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-32insurance" name="sourceIncome[]" value="Insurance" />
    ...
    <div class="columncheckbox">
            <div class="gender">
              <input type="checkbox" id="check-32spousepension" name="sourceIncome[]" value="Spouse Pension" />
              <label for="check-32spousepension">Spouse Pension</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-32rentals" name="sourceIncome[]" value="Rentals / sharecrops" />
            ...
            <div class="gender">
              <input type="checkbox" id="check-32livestock" name="sourceIncome[]" value="Livestock / orchard / farm"/>
            ...
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" placeholder="Others" name="sourceIncomeOthers" value=""  maxlength="20"/>
        </div>
        ...
        <br>
          <div class="gender-option">   
            ...
            <div class="gender">
              <input type="checkbox" id="check-33houselot" name="assetsFirst[]" value="House & Lot" />
              <label for="check-33houselot">House & Lot</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-33commercial" name="assetsFirst[]" value="Commercial Building"/>
              <label for="check-33commercial">Commercial Building</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-33fishpond" name="assetsFirst[]" value="Fishpond / resort"/>
              <label for="check-33fishpond">Fishpond / resort</label>
            </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" placeholder="Others" name="assetsFirstOthers" value=""  maxlength="20"/>
        </div>
          </div>
        ...
        <div class="columncheckbox">
            <div class="gender">
              <input type="checkbox" id="check-34automobile" name="assetsSecond[]" value="Automobile"/>
              <label for="check-34automobile">Automobile</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-34pc" name="assetsSecond[]" value="Personal Computer" />
            ...
            <div class="gender">
              <input type="checkbox" id="check-34heavyequipment" name="assetsSecond[]" value="Heavy Equipment" />
              <label for="check-34heavyequipment">Heavy Equipment</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-34laptops" name="assetsSecond[]" value="Laptops" />
    ...
    <div class="columncheckbox">
            <div class="gender">
              <input type="checkbox" id="check-34motorcycle" name="assetsSecond[]" value="Motorcycle"/>
              <label for="check-34motorcycle">Motorcycle</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-34mobilephones" name="assetsSecond[]" value="Mobile Phones" />
              <label for="check-34mobilephones">Mobile Phones</label>
            </div>
    </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" placeholder="Others" name="assetsSecondOthers" value=""  maxlength="20"/>
        </div>
        ...
        <b>35. Monthly Income (in Philippine Peso)</b>
          <div class="gender-option">
            ...
            <div class="column">
            <div class="gender">
              <input type="radio" id="radio-35sixty" name="monthlyIncome"  value="60,000 and above"/>
              <label for="radio-35sixty">60,000 and above</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35fifty" name="monthlyIncome" value="50,000 to 60,000"/>
              <label for="radio-35fifty">50,000 to 60,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35fourty" name="monthlyIncome" value="40,000 to 50,000" />
              <label for="radio-35fourty">40,000 to 50,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35thirty" name="monthlyIncome" value="30,000 to 40,000"/>
              <label for="radio-35thirty">30,000 to 40,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35twenty" name="monthlyIncome" value="20,000 to 30,000" />
              <label for="radio-35twenty">20,000 to 30,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35ten" name="monthlyIncome" value="10,000 to 20,000" />
              <label for="radio-35ten">10,000 to 20,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35five" name="monthlyIncome"  value="5,000 to 10,000"/>
              <label for="radio-35five">5,000 to 10,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35one" name="monthlyIncome" value="1,000 to 5,000"/>
              <label for="radio-35one">1,000 to 5,000</label>
            </div>
            <div class="gender">
              <input type="radio" id="radio-35belowone" name="monthlyIncome" value="Below 1,000" />
        ...
        <b>36. Problems / Needs Commonly Encountered (Check all applicable)</b>
            ...
            <div class="gender">
              <input type="checkbox" id="check-36lackofincome" name="problems[]" value="Lack of income / resources" />
              <label for="check-36lackofincome">Lack of income / resources</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-36lossofincome" name="problems[]" value="Loss of income / resources"/>
              <label for="check-36lossofincome">Loss of income / resources</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-36skills" name="problems[]" value="Skills / capability training" />
              <label for="check-36skills">Skills / capability training</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-36livelihood" name="problems[]" value="Livelihood opportunities"/>
              <label for="check-36livelihood">Livelihood opportunities</label>
            </div>
         
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="problemsOthers" value=""  maxlength="20"/>
        </div>
      </div>
    ...
    <h1 style="background-color: lightblue; color: black;font-size: 25px">VI. Health Profile</h1>
        ...
        <div class="input-box" id="invitext"></div>
          ...
          <input type="text" class="gray-input" placeholder="Others" name="physicalDisability"  maxlength="50"/>
        </div>

        <div class="gender-box">
        <div class="columncheckbox">
            <div class="gender">
              <input type="checkbox" id="check-37healthproblems" name="medicalConcern[]" value="Health problems/ ailments"/>
              <label for="check-37healthproblems">Health problems/ ailments</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-37hypertension" name="medicalConcern[]" value="Hypertension" />
              <label for="check-37hypertension">Hypertension</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-37arthritis" name="medicalConcern[]" value="Arthritis / Gout" />
              <label for="check-37arthritis">Arthritis / Gout</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-37coronary" name="medicalConcern[]" value="Coronary Heart Disease"/>
              <label for="check-37coronary">Coronary Heart Disease</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-37diabetes" name="medicalConcern[]" value="Diabetes"/>
              <label for="check-37diabetes">Diabetes</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-37chronic" name="medicalConcern[]" value="Chronic Kidney Disease" />
              <label for="check-37chronic">Chronic Kidney Disease</label>
            </div>
    </div>
    <div class="columncheckbox">
            <div class="gender">
              <input type="checkbox" id="check-37alzheimer" name="medicalConcern[]" value="Alzheimer / Dementia" />
              <label for="check-37alzheimer">Alzheimer / Dementia</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-37chronicobstructive" name="medicalConcern[]" value="Pulmonary Disease"/>
              <label for="check-37chronicobstructive">Chronic Obstructive Pulmonary Disease</label>
            </div>
    </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="medicalConcernOthers" maxlength="20"/>
        </div>
        ...
        <b>38. Dental Concern</b>
            <div class="gender">
              <input type="radio" id="radio-38dentalcare" name="dentalConcern" value="Needs Dental Care" />
              <label for="radio-38dentalcare">Needs Dental Care</label>
            </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="dentalConcernOthers" maxlength="20"/>
        </div>
        ...
        <b>39. Optical</b>
            ...
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="opticalOthers" maxlength="20"/>
        </div>
        ...
        <b>40. Hearing</b>
            ...
            <div class="gender">
              <input type="radio" id="radio-40aural" name="hearing" value="Aural impairment / Hearing impairment"/>
              <label for="radio-40aural">Aural impairment / Hearing impairment</label>
            </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="hearingOthers" maxlength="20"/>
        </div>
          ...
          <div class="gender">
              <input type="checkbox" id="check-41neglect" name="socialEmotional[]" value="Feeling neglect / rejection"/>
              <label for="check-41neglect">Feeling neglect / rejection</label>
            </div>

            <div class="gender">
              <input type="checkbox" id="check-41helplessness" name="socialEmotional[]" value="Feeling helplessness / worthlessness"/>
              <label for="check-41helplessness">Feeling helplessness / worthlessness</label>
            </div>

            <div class="gender">
              <input type="checkbox" id="check-41loneliness" name="socialEmotional[]" value="Feeling loneliness / isolate"/>
              <label for="check-41loneliness">Feeling loneliness / isolate</label>
            </div>

            <div class="gender">
              <input type="checkbox" id="check-41leisure" name="socialEmotional[]" value="Lack leisure / recreational activities"/>
              <label for="check-41leisure">Lack leisure / recreational activities</label>
            </div>

            <div class="gender">
              <input type="checkbox" id="check-41lacksc" name="socialEmotional[]" value="Lack SC friendly environment"/>
              <label for="check-41lacksc">Lack SC friendly environment</label>
            </div>
            
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="socialEmotionalOthers" maxlength="20"/>
        </div>
        ...
        <b>42. Area / Difficulty</b>
            ...
            <div class="gender">
              <input type="checkbox" id="check-42highcost" name="areaDifficulty[]" value="High Cost of medicines"/>
              <label for="check-42highcost">High Cost of medicines</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-42lackofmedicines" name="areaDifficulty[]" value="Lack of medicines" />
              <label for="check-42lackofmedicines">Lack of medicines</label>
            </div>
            <div class="gender">
              <input type="checkbox" id="check-42lackofmedical" name="areaDifficulty[]" value="Lack of medical attention"/>
              <label for="check-42lackofmedical">Lack of medical attention</label>
            </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="areaDifficultyOthers" maxlength="20"/>
        </div>
        ...
        <div class="input-box">
          ...
          <input type="text" class="gray-input" placeholder="Example : Amlodiphne 10mg, Losartan 50mg, etc." name="medicines"/>
        </div>
        ...
        <b>45. If Yes, when is it done?</b>
            ...
            <div class="gender">
              <input type="radio" id="radio-45sixmonths" name="scheduledMedical1" value="Every 6 months"/>
              <label for="radio-45sixmonths">Every 6 months</label>
            </div>
            <div class="input-box">
          <label>Others, pls specify</label>  
          <input type="text" class="gray-input" placeholder="Others" name="scheduledMedical1Others" maxlength="14"/>
        </div>
    </div>
<br><br>
<div class="gender">
...
person, being part of the establishment of database of Senior Citizens." required/>
              <label for="lastrequired">This certifies that I have willingly given my personal consent and willfully participated in the provision of data and relevant information regarding my
person, being part of the establishment of database of Senior Citizens.</label>
    ...
    <div class="column">
        ...
        <button  class="submitbutton" type="submit" name="create" value="Add Person">Submit</button>
      </div>
      </div>
