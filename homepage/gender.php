...
$sqlCount = "SELECT COUNT(*) as total FROM people WHERE gender = '$selectedGender'";
$sqlSelect = "SELECT * FROM people WHERE gender = '$selectedGender' ORDER BY updated_date DESC LIMIT $offset, $recordsPerPage";
...
<body>
    ...
    <section class="home-section">
      <nav>
        <div class="sidebar-button">
          ...
          <span class="dashboard">Gender: <?php echo $selectedGender; ?></span>
  ...
  <?php if ($currentpage > 1) : ?>
    <a href="?page=1<?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&gender=<?php echo $selectedGender; ?>">First</a>
    <a href="?page=<?php echo ($currentpage - 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&gender=<?php echo $selectedGender; ?>">Previous</a>
  <?php endif; ?>
  ...
  <?php for ($i = $startPage; $i <= $endPage; $i++) : ?>
    ...
    <?php else : ?>
      <a href="?page=<?php echo $i; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&gender=<?php echo $selectedGender; ?>"><?php echo $i; ?></a>
    <?php endif; ?>
  <?php endfor; ?>

  <?php if ($currentpage < $totalPages) : ?>
    <a href="?page=<?php echo ($currentpage + 1); ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&gender=<?php echo $selectedGender; ?>">Next</a>
    <a href="?page=<?php echo $totalPages; ?><?php echo $searchQuery ? '&searchQuery=' . urlencode($searchQuery) : ''; ?>&gender=<?php echo $selectedGender; ?>">Last</a>
  <?php endif; ?>
</div>
      </div>
    </section>
